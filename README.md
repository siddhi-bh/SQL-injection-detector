...
> It is not a substitute for proper input validation or security controls.  
> Always use parameterized queries and security best practices in real applications.

## 🧠 What I Learned:

- How SQL injection works.
- How to detect suspicious SQL inputs with regex.
- How to build a GUI using `tkinter`
- The importance of input sanitization and secure coding.
